---
title: Redirects test page (hidden)
...
Hidden test page with redirects
...
(Many to one) `https://experienceleague.adobe.com/docs/analytics/analyze/reports-analytics/*`
...
Landing pages, other domains, nginx config
