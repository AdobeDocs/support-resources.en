...
>[!NOTE]
>
>In the [Global Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration#request-access-to-the-global-admin-console), select an organization and navigate to **[!UICONTROL Products]**. You can activate all or selected services for a product using Product Profiles.
...
>[!NOTE]
>
>For some products, you can't create or edit Product Profiles in the Global Admin Console. In such cases, use the [Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/admin-console-overview) instead.
...
1. In the **[!UICONTROL Add Profile]** dialog box, enter the following details:
   ...
   | **[!UICONTROL Admins]** | Select from the dropdown or enter an admin's email address. If the admin doesn't yet exist, create them first via the [**[!UICONTROL Admins]**](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators) tab. |
...
- [Adopt global administration](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)
- [Manage administrators](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators)
- [Manage user groups](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-user-groups)
- [Allocate products to child organizations](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/allocate-products)
