...
- [Manage product profiles](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-product-profiles)
...
Enter the name or email address of the user. You can search for existing users or add a user by specifying a valid email address and filling in the information on screen. Click **[!UICONTROL Save]**. An email is sent to the user or group confirming access to the application. 
...
System and contract admins can manage their organization's Adobe contracts from the **[!UICONTROL Account]** tab in the Admin Console.
...
The **[!UICONTROL Storage page]** in the [Admin Console](https://adminconsole.adobe.com) gives you visibility of storage across your Creative Cloud applications. The storage quotas are flexible for end users up to the amount of storage purchased by the organization.
...
The **[!UICONTROL Packages]** page in the [Admin Console](https://adminconsole.adobe.com) provides the following functionality. Use them when you plan to deploy desktop applications to end users in your organization.

- Download pre-configured packages by using [Adobe Templates](https://helpx.adobe.com/enterprise/using/package-templates.html).
- Create customized [Named User Licensing](https://helpx.adobe.com/enterprise/using/create-nul-packages.html) or [Shared Device](https://helpx.adobe.com/enterprise/using/create-sdl-packages.html) Licensing (for educational institutions) packagers with the configuration and applications you want your end users to have.
...
- Download the IT tools like [Remote Update Manager](https://helpx.adobe.com/enterprise/using/using-remote-update-manager.html) and [Adobe Update Server Setup Tool](https://helpx.adobe.com/enterprise/using/update-server-setup-tool.html).
- Download the Adobe Extension Manager command-line tool to [install extensions and plug-ins](https://helpx.adobe.com/enterprise/using/manage-extensions.html) from the ZXP file container format.
...
[Identity types](https://helpx.adobe.com/enterprise/using/identity.html) allow organizations to have different levels of control over users' accounts and data. It impacts how your organization stores and shares assets.
