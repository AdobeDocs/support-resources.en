...
In the Global Admin Console, you can select an organization and navigate to the **[!UICONTROL Admins]** tab to add, edit, or remove admin rights. Each organization in the hierarchy is an Adobe Admin Console; see [Adopt global administration](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration) for how the Global Admin Console groups those consoles. Sign in to the [Global Admin Console](https://global-admin-console.adobe.com) for hierarchy-wide tasks, or to the [Adobe Admin Console](https://adminconsole.adobe.com) for tasks within a single organization.
