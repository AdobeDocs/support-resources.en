...
System Insights appear throughout the case creation workflow. As issue details are entered, the **[!UICONTROL System Insights]** panel appears on the right side of the screen, above the AI‑powered recommendations section. To learn more about AI‑powered recommendations, see [Fill out the support ticket](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#fill-out-the-support-ticket) in the Adobe Customer Support Experience article.
