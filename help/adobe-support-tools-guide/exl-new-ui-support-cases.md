...
2. In the **[!UICONTROL Problem Description]** section, enter a description of the issue. The case title is automatically generated based on the issue description. You can edit the title if needed. Confirm whether the issue can be reproduced. Select **[!UICONTROL Yes]** if the issue is reproducible. A text box appears where you can describe the steps required to reproduce the issue. Select **[!UICONTROL No]** if the issue cannot be consistently reproduced, and click **[!UICONTROL Next]**.
   ...
   Select **[!UICONTROL Classic Form]** or **[!UICONTROL AI Chat]** in the upper-right corner to switch the case creation experience. For AI chat details, see [AI chat in the case creation experience](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#ai-chat-in-the-case-creation-experience).
...
>[!TIP]
>
>If you don't see the **[!UICONTROL Open Case]** option or the **[!UICONTROL Open a support case]** card, contact your System Administrator to assign the Support admin role.
...
- **[!UICONTROL Status]** — Awaiting Assignment, In Progress, Issue Obsolete, Resolution Confirmed, Resolution Irrelevant
