...
To submit a new support case using the start page of Adobe Experience League, refer to [Create a support ticket with Experience League](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#create-a-support-ticket-with-experience-league).
...
1. Fill in the [fields](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-support-ticket-contact-reason-descriptions).
1. Click **Submit**.
...
1. Click on **[!UICONTROL Escalate to management]** at the bottom right of the *[!UICONTROL Case Detail]* panel on the right side of the screen.
    ...
    ![escalate-to-management](/help/adobe-support-tools-guide/assets/escalate_to_management.png)
...
>[!NOTE] 
>
>The user must have an existing account before they can be granted Shared Access - refer to [Create a Commerce account](https://experienceleague.adobe.com/en/docs/commerce-admin/start/commerce-account/commerce-account-create#create-a-commerce-account) for more details.
...
1. Find the user to revoke shared access from and click ![remove icon](/help/adobe-support-tools-guide/assets/remove_icon.png){width="25"} in the user's row (**Actions** column).
...
If you have/had an Adobe Commerce Cloud project and had added a user to the project, they might have been automatically granted Shared Access on the Project Owner's MAGE ID. This would normally be indicated in the **[!UICONTROL Share Name]** column, showing *Cloud Shared Access from MAG[XYZ]*.
...
It's not possible to delete the list of Shared Access users with the Share Name of *Cloud Shared Access from MAG[XYZ]* if the Shared Access wasn't added/given [on this page](https://account.magento.com/grantor/manage/). These are retained for informational/audit purposes.
