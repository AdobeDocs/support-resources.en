...
description: Support Insights proactively identify potential issues in Adobe Commerce environments. Reviewing insights during case creation reduces resolution time, helps prevent outages, and supports a stable and secure deployment.
---
# Support Insights
...
Support Insights appear during the case creation process and help accelerate diagnosis and resolution.

## How Support Insights are created
...
When a check identifies a value or state outside the safe range defined by Adobe product and support teams, the system surfaces it as a Support Insight.

## Why Support Insights matter

Regularly reviewing Support Insights helps identify problems early, before they affect system stability or customer experience. This proactive approach:
